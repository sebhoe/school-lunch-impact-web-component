    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img1, file, 203, 8, 5607);
    			attr_dev(div7, "class", "icon");
    			add_location(div7, file, 202, 6, 5580);
    			attr_dev(strong6, "class", "text text--orange text--large");
    			add_location(strong6, file, 207, 10, 5708);
    			add_location(sub, file, 213, 21, 5946);
    			attr_dev(span0, "class", "text text--orange");
    			add_location(span0, file, 212, 10, 5892);
    			add_location(br1, file, 215, 10, 6000);
    			attr_dev(strong7, "class", "text text--orange text--large");
    			add_location(strong7, file, 216, 10, 6031);
    			attr_dev(span1, "class", "text text--orange");
    			add_location(span1, file, 219, 10, 6167);
    			add_location(p6, file, 206, 8, 5694);
    			add_location(div8, file, 205, 6, 5680);
    			if (img2.src !== (img2_src_value = "/img/proveg-logo.svg")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "proveg logo");
    			add_location(img2, file, 223, 8, 6281);
    			attr_dev(div9, "class", "logo");
    			add_location(div9, file, 222, 6, 6254);
    			attr_dev(div10, "class", "link");
    			add_location(div10, file, 225, 6, 6353);
    			attr_dev(div11, "class", "banner");
    			add_location(div11, file, 201, 4, 5553);
    			if (img3.src !== (img3_src_value = "/img/icons/waterdrop.png")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "waterdrop icon");
    			add_location(img3, file, 229, 8, 6489);
    			attr_dev(div12, "class", "icon");
    			add_location(div12, file, 228, 6, 6462);
    			attr_dev(strong8, "class", "text text--blue text--large");
    			add_location(strong8, file, 233, 10, 6596);
    			attr_dev(span2, "class", "text text--blue");
    			add_location(span2, file, 236, 10, 6711);
    			add_location(br2, file, 237, 10, 6772);
    			attr_dev(strong9, "class", "text text--blue text--large");
    			add_location(strong9, file, 238, 10, 6803);
    			attr_dev(span3, "class", "text text--blue");
    			add_location(span3, file, 243, 10, 7006);
    			add_location(p7, file, 232, 8, 6582);
    			add_location(div13, file, 231, 6, 6568);
    			if (img4.src !== (img4_src_value = "/img/proveg-logo.svg")) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "proveg logo");
    			add_location(img4, file, 247, 8, 7113);
    			attr_dev(div14, "class", "logo");
    			add_location(div14, file, 246, 6, 7086);
    			attr_dev(div15, "class", "link");
    			add_location(div15, file, 249, 6, 7185);
    			attr_dev(div16, "class", "banner");
    			add_location(div16, file, 227, 4, 6435);
    			if (img5.src !== (img5_src_value = "/img/icons/forrest.png")) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "alt", "forrest icon");
    			add_location(img5, file, 253, 8, 7321);
    			attr_dev(div17, "class", "icon");
    			add_location(div17, file, 252, 6, 7294);
    			attr_dev(strong10, "class", "text text--green text--large");
    			add_location(strong10, file, 257, 10, 7424);
    			add_location(sup, file, 262, 42, 7637);
    			attr_dev(span4, "class", "text text--green");
    			add_location(span4, file, 262, 10, 7605);
    			add_location(br3, file, 263, 10, 7673);
    			attr_dev(strong11, "class", "text text--green text--large");
    			add_location(strong11, file, 264, 10, 7704);
    			attr_dev(span5, "class", "text text--green");
    			add_location(span5, file, 269, 10, 7912);
    			add_location(p8, file, 256, 8, 7410);
    			add_location(div18, file, 255, 6, 7396);
    			if (img6.src !== (img6_src_value = "/img/proveg-logo.svg")) attr_dev(img6, "src", img6_src_value);
    			attr_dev(img6, "alt", "proveg logo");
    			add_location(img6, file, 273, 8, 8024);
    			attr_dev(div19, "class", "logo");
    			add_location(div19, file, 272, 6, 7997);
    			attr_dev(div20, "class", "link");
    			add_location(div20, file, 275, 6, 8096);
    			attr_dev(div21, "class", "banner");
    			add_location(div21, file, 251, 4, 7267);
    			add_location(section1, file, 187, 2, 5162);
    			attr_dev(section2, "class", "spacer");
    			add_location(section2, file, 278, 2, 8189);
